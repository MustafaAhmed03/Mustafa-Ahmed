...
function depositAnswer() {
  if (document.getElementById("depositCorrect").disabled === false) {
    var depositResult =
      "Correct! You deposited $" + depositNum + " this month.";
  } else {
    var depositResult =
      "Not quite, you deposited $" + depositNum + " this month.";
  }
...
function amazonAnswer() {
  if (document.getElementById("amazonCorrect").disabled === false) {
    var amazonResult =
      "Correct. You spent $" + amazonSum + " at Amazon this month.";
  } else {
    var amazonResult =
      "Not quite, you spent $" + amazonSum + " at Amazon this month.";
  }
...
function personalAnswer() {
  if (document.getElementById("personalCorrect").disabled === false) {
    var personalResult =
      "Correct. You spent $" + personal + " via Venmo this month.";
  } else {
    var personalResult =
      "Not quite, you spent $" + personal + " via Venmo this month.";
  }
...
function funAnswer() {
  if (document.getElementById("funCorrect").disabled === false) {
    var funResult =
      "Correct. You spent $" + funNum + " on concert tickets this month.";
  } else {
    var funResult =
      "Not quite, you spent $" + funNum + " on concert tickets this month.";
  }
